...
from servisces.blob_service import upload_blob
from servisces.credit_card_service import analize_credit_card
...
if uploaded_file is not None:
    ...
    if blob_url:
        ...
        credits_card_info = analize_credit_card(blob_url)
...
def show_image_and_validation(blob_url, credit_card_info):
    ...
    if credit_card_info and credit_card_info["card_name"]:
        st.markdown(f"<h1 style='color: green;'>Cartão Válidos<h1>", unsafe_allow_html=True)
